const translations = {
  ...
  ru: {
    back: "Назад",
    bulkDiscounts: "Скидки на оптовые покупки",
    specifyDiscount:
      "Укажите диапазон количества товара и процент скидки для скидок",
    productQuantity: "Количество товара",
    quantityInfo:
      "Сколько покупок товара вы хотите указать для определения скидки?",
    discount: "Скидка",
    discountInfo: "Какой процент скидки вы хотите установить?",
    unselected: "Не выбрано",
    test: "Тест",
    discountImageAlt: "Скидка",
  },
};
